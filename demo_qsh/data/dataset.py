...
def load_text_data():
    ...
    with open(os.path.join(ABS_PATH, "data/test_text_data_part.json")) as f:
        train_X = json.load(f)
    with open(os.path.join(ABS_PATH, "data/test_label_part.json")) as f:
        train_Y = json.load(f)
    with open(os.path.join(ABS_PATH, "data/test_relation_part.json")) as f:
        train_Z = json.load(f)
    ...
    data['X_test']=copy.deepcopy(convert_len(train_X))
    data['entity_test']=copy.deepcopy(convert_len(train_Y))
    data['relation_test']=copy.deepcopy(convert_len(train_Z))
...
class Dataget():
    ...
    def __init__(self):
        ...
        #self.valid_data = Dataget_sub(data['X_valid'], data['entity_valid'], data['relaion_valid'])
